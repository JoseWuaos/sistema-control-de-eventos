    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $asistencia["participante"]["cedula"] }}</td>
                    <td>
                        {{ $asistencia["participante"]["primer_nombre"] }}
                        {{ $asistencia["participante"]['segundo_nombre'] }}
                        {{ $asistencia["participante"]['primer_apellido'] }}
                        {{ $asistencia["participante"]['segundo_apellido'] }}
                    </td>
                    <td>{{ $asistencia['asistencia'] }}</td>
                    <td>{{ $asistencia["participante"]['genero']['descripcion'] }}</td>
