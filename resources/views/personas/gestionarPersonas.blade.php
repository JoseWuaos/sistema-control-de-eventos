                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="number" id="cedula" name="cedula" class="form-control"
                            value="<?= isset($personas) ? $personas['cedula'] : '' ?>" require> 
                    </div>
                    <div class="col-sm-6">
                        ...
                        <input type="text" id="primer_nombre" name="primer_nombre" class="form-control"
                            value="<?= isset($personas) ? $personas['primer_nombre'] : '' ?>" require>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <input type="text" id="segundo_nombre" name="segundo_nombre" class="form-control"
                            value="<?= isset($personas) ? $personas['segundo_nombre'] : '' ?>" require>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <input type="text" id="primer_apellido" name="primer_apellido" class="form-control"
                            value="<?= isset($personas) ? $personas['primer_apellido'] : '' ?>" require>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <input type="text" id="segundo_apellido" name="segundo_apellido" class="form-control"
                            value="<?= isset($personas) ? $personas['segundo_apellido'] : '' ?>" require>
                    </div>
                    <div class="col-sm-6">
                        <label for="Fecha_nacimiento" class="form-label">Fecha nacimiento</label>
                        <input type="date" id="Fecha_nacimiento" name="fecha_nacimiento" class="form-control"
                            value="<?= isset($personas) ? $personas['fecha_nacimiento']->format('Y-m-d') : ''  ?>" require>
                    </div>
                    <div class="col-sm-6">
